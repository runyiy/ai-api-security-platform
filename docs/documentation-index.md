...
3. [Research Assistant roadmap](research-assistant-roadmap.md#5-固定阶段与依赖)是当前阶段进度入口；[W2 runtime validation](research-ai-w2-runtime-validation.md#w2-implementation-and-acceptance)记录后续 fake-only 本地实现、T/X/Y 证据与独立审查状态，并保留 PR #153 前提增量的 hosted 历史。W2 已经 PR #155 集成；[W3 cache 本地候选](research-ai-provider-implementation.md#w3-application-analysis-cache)待独立审查，RA-06 未开始。
...
| D06 | [research-ai-budget-contract.md](research-ai-budget-contract.md) | B1–B8 预算/观察设计、算术与 T1–T12 | 已采纳设计；W2 fake-only 经 PR #155 集成 | D09, D10, D11, D14 |
...
| D08 | [research-ai-provider-implementation.md](research-ai-provider-implementation.md) | W1 adapter、timing 修正与 W3 cache 证据 | W1 PR #150 已集成，W3 本地候选待审；live acceptance/operational permissions 未完成 | D06, D07, D09, D11, D14 |
| D09 | [research-ai-w2-implementation-contract.md](research-ai-w2-implementation-contract.md) | Q 表、严格 records/interfaces、G/A、X/Y 与 acceptance 映射 | v0.1.1 已审设计，N1 已采纳；W2 实现经 PR #155 集成 | D06, D10, D11, D14 |
| D10 | [research-ai-w2-runtime-validation.md](research-ai-w2-runtime-validation.md) | W2 fake-only 实现、T/X/Y 本地证据及 N1/Linux/AppArmor 历史 | PR #155 已集成；保留修复与 PR #153 前提历史 | D06, D09, D11, D14 |

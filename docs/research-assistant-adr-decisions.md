...
| ADR-RA-TASK | 第 9 节及 [W2预算/观察提案](research-ai-budget-contract.md)：预算/观察与 M8 精确计划协调分工；PostgreSQL仍为推荐 | Tech Lead 批准状态/事务/恢复；操作者批准硬预算与审批操作。RA-06 实施前，若更早引入审批聚合则更早 | **B1–B8 bounded W2 recommendations ADOPTED; concrete pre-code review/N1 and broader TASK choices pending** |
...
**Current W2 dependency:** B1–B8 are adopted as recorded [above](research-ai-budget-contract.md#w2-design-adoption-record); the [concrete B1/B8 contract](research-ai-w2-implementation-contract.md) and separately proposed N1 require their stated pre-code review/decision. TASK choices outside this bounded adoption, operational budgets and real use remain pending.

...
**v0.1.1 · reviewed design / N1 adopted · broader W2 implementation incomplete.** Reviewed `302b1e581f4e0e559a0f16f924d1ca64ea985adb` was integrated through [PR #152](https://github.com/runyiy/ai-api-security-platform/pull/152). The subsequent [N1 adoption and runtime prerequisite](research-ai-w2-runtime-validation.md#adoption-and-scope) includes mandatory Linux/bubblewrap and the narrowly adopted CI AppArmor policy; PR #153 passed runtime integration. That increment does not implement the preparation/accounting/permit/lifecycle protocol below.

...
- [Documentation index](docs/documentation-index.md): document purposes, authority, inbound references and historical/current status.
- [Research Assistant v1 roadmap](docs/research-assistant-roadmap.md): adopted decisions, integrated increments, remaining work and acceptance requirements; RA-05/W2 is integrated; W3 fake-only cache work is a local review candidate.
